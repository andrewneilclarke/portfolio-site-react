...
const Projects = () => {
    return (
        ...
        <h2 className="project"><button className="button page-link"><a href="http://" target="#"></a>Project 4</button></h2>
                <h2 className="project"><button className="button page-link"><a href="http://" target="#"></a>Project 5</button></h2>
                <h2 className="project"><button className="button page-link"><a href="http://" target="#"></a>Project 6</button></h2>
                
        </div>
        <div className="flex-item">
                
        <h2 className="project"><button className="button page-link"><a href="http://" target="#"></a>Project 7</button></h2>
